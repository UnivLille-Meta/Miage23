...
### Ezzahra
La première séance, j'ai eu l'opportunité de créer ma première application pharo, j'ai appris comment créer des packages et des classes, je trouve que c'est un langage intuitif qui represente le OOP et facilite la compréhension du processus de developpement. Patricia, ayant plus d'experience en Pharo, m'a aidé à créer mon premier projet Pharo. Ainsi, j'ai créé un repo sur Git.  
